...
import StyledLinkClient from "@/components/StyledLinkClient";
...
export default function SustainableRetreatClient() {
  ...
  return (
    <>
      ...
      <div className="-mx-8-25 grid grid-rows-5 divide-y divide-[#A5D6A7] border-y border-[#A5D6A7] md:col-span-2 md:col-start-2 md:row-start-2 md:mx-0">
