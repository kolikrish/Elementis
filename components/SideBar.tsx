...
export default function SideBar({ setOpenSideBar }: SideBarProps) {
  ...
  const data: LinkItem[] = [
    ...
    { href: "#", link: "Wellness", src: Wellness },
    {
      href: "#",
      link: "Innovation",
      src: Innovation,
  ...
  return (
    ...
    >
      <motion.div
        className="flex h-screen bg-[#E8F5E9]"
        ...
        <div className="flex-1 pt-7000svh pr-16 pb-3500svh pl-48">
          ...
          >
            <motion.div
              ...
              id="contact-us"
              className="space-y-2400svh text-1800svh text-[#0F1E16]"
            >
              <div className="text-[#0F1E16]/80">Contact Us</div>
              <div className="flex items-center [&_.animated-underline]:h-[2px] [&_.animated-underline]:bg-[#0F1E16]">
            ...
            >
              <StayConnected
                ...
                className="gap-y-2400svh text-1800svh text-[#0F1E16]/80 [&_div]:gap-x-10 [&_svg]:h-2400svh [&_svg]:w-auto [&>:first-child]:text-[#0F1E16]/80"
              />
            </motion.div>
            <motion.div
              variants={variants}
            ...
            >
              <Link href="#">
                <DashedLink className="w-fit text-[#0F1E16] [&_.animated-underline]:h-[2px] [&_.animated-underline]:bg-[#0F1E16]">
                  Policy and Terms
                </DashedLink>
              </Link>
            </motion.div>
