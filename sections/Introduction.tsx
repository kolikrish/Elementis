...
export default function Introduction() {
  return (
    <div className="grid grid-rows-[auto_auto_auto] gap-y-12 bg-[#0F1E16] px-3-75 pt-42-5 pb-35 text-[#A5D6A7] md:grid-cols-[1fr_1.9fr] md:grid-rows-[auto_auto] md:gap-y-32 md:px-15 md:pt-56-25 md:pb-50">
