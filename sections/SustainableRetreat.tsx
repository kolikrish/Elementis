...
import ResponsiveMaskTextVariant from "@/components/ResponsiveMaskTextVariant";
import ResponsiveMarquee from "@/components/ResponsiveMarquee";
import SustainableRetreatClient from "@/components/SustainableRetreatClient";

export default function SustainableRetreat() {
  return (
    <div className="bg-[#183023] py-36 text-[#A5D6A7] md:py-60">
      <ResponsiveMarquee
        animationConfig={{
          mobile: {
            max: "-887px",
